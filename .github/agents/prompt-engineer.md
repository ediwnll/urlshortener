...
tools: ['vscode', 'execute', 'read', 'edit', 'search', 'web/fetch', 'docs-by-langchain/*', 'agent', 'pylance-mcp-server/*', 'ms-python.python/getPythonEnvironmentInfo', 'ms-python.python/getPythonExecutableCommand', 'ms-python.python/installPythonPackage', 'ms-python.python/configurePythonEnvironment', 'todo', '4regab.tasksync-chat/askUser']
---
